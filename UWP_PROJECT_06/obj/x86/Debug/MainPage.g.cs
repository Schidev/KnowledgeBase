...
namespace UWP_PROJECT_06
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMainPage_Bindings
        {
            ...
            {
                if (lineNumber == 304 && columnNumber == 75)
                {
                    isobj4CommandParameterDisabled = true;
                }
                else if (lineNumber == 233 && columnNumber == 31)
                {
                    isobj5AddTabButtonCommandParameterDisabled = true;
                }
                else if (lineNumber == 139 && columnNumber == 71)
                {
                    isobj7CommandParameterDisabled = true;
                }
                else if (lineNumber == 145 && columnNumber == 71)
                {
                    isobj8CommandParameterDisabled = true;
                }
                else if (lineNumber == 151 && columnNumber == 65)
                {
                ...
                else if (lineNumber == 49 && columnNumber == 87)
                {
                ...
                else if (lineNumber == 53 && columnNumber == 87)
                {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 4: // MainPage.xaml line 303
                        this.obj4 = (global::Windows.UI.Xaml.Controls.Button)target;
                        break;
                    case 5: // MainPage.xaml line 230
