#pragma checksum "C:\Users\Q\Documents\00000_EVERYTHING\20000_MEDIA\26000_PROGRAMMING\26100_PROJECTS\26110_C_SHARP\26111_UWP\UWP_PROJECT_06\UWP_PROJECT_06\MainPage.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "BB9DD986AA4DA6A5DFE513DD6C28A0D13053B07E0C989B4B724B0966C85B3D81"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace UWP_PROJECT_06
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMainPage_Bindings
        {
            ...
            {
                if (lineNumber == 329 && columnNumber == 75)
                {
                    isobj4CommandParameterDisabled = true;
                }
                else if (lineNumber == 258 && columnNumber == 31)
                {
                    isobj5AddTabButtonCommandParameterDisabled = true;
                }
                else if (lineNumber == 144 && columnNumber == 71)
                {
                    isobj7CommandParameterDisabled = true;
                }
                else if (lineNumber == 155 && columnNumber == 71)
                {
                    isobj8CommandParameterDisabled = true;
                }
                else if (lineNumber == 166 && columnNumber == 65)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            switch(connectionId)
            {
            case 2: // MainPage.xaml line 219
                {
                    this.leftPane = (global::Windows.UI.Xaml.Controls.Grid)(target);
                }
                break;
            case 3: // MainPage.xaml line 346
                {
